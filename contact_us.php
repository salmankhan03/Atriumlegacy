    ...
    <div class="middle_inner">
        ...
        <div class="contactUsBanner">
            <div class="container text-center banner-paddings">
                <h2 class="banner-header text-center">Contact Us</h2>
                <h2 class="banner-title">We welcome your questions, ideas, and interest in supporting healthy aging in our community.</h2>
            </div>
        </div>
        <!-- Banner -->
    ...
    <script>
        ...
        form.addEventListener('submit', function(e) {
            ...
            grecaptcha.ready(function() {
                grecaptcha.execute('6LcdmPkrAAAAAIwGqAkl04My2kr5fYy-UlDNaMyZ', {
                    action: 'submit'
                }).then(function(token) {
