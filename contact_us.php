    ...
    <html lang="en">
        <head>
            ...
            /* Basic form container style */
                ...
                /* Input fields container with icons */
                .style-line {
                    position: relative;
                    display: flex;
                    align-items: center;
                ...
                /* Left-side icons for input fields */
                .icon-name::before,
                .icon-email::before,
                .icon-phone::before,
                .icon-subject::before,
                        ...
                        <div id="cmsmasters_row_ftj2oeok3p " class="cmsmasters_row cmsmasters_color_scheme_default cmsmasters_row_top_default cmsmasters_row_bot_default cmsmasters_row_fullwidth">
                            <div class="cmsmasters_row_outer_parent">
                                <div class="cmsmasters_row_outer container">
                                    <div class="cmsmasters_row_inner cmsmasters_row_fullwidth cmsmasters_row_no_margin p-0">
                                        <div class="cmsmasters_row_margin cmsmasters_row_columns_behavior">
                                            <div id="cmsmasters_column_70ununv578" class="cmsmasters_column one_third" style = "padding-left:20px">
                                                <div class="cmsmasters_column_inner">
                                                    <div id="" class="">
                                                        <div class="featured_block_inner">
                                                            <div class="featured_block_text pt-4">
                                                                ...
                                                                <div id="cmsmasters_heading_7h3t5mz79l" class="cmsmasters_heading_wrap cmsmasters_heading_align_left">
                                                                    <h4 class="cmsmasters_heading marginBottom">+1 (840) 841-2569</h4>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
