        ...
        <div class="middle_inner">
            ...
            <div class="initiativeBanner">
                <div class="container text-center banner-paddings">
                    <h2 class="banner-header text-center white-text">Our Initiatives</h2>
                    <h2 class="banner-title">Supporting healthy aging through prevention, connection, and community-based solutions.</h2>
                </div>
            </div>
            ...
            <div class="row ml-0 mr-0">
               ...
               <div class="col-sm-12 col-md-6 col-lg-6 pl-0 pr-0 d-flex align-items-center">
                  <div class="p-5 right-content-padding">
                        ...
                        <div class="col-sm-12 col-md-8 col-lg-8 pl-0 pr-0">
                           <div class="mt-5">
                              <div class="tabs-cards pl-3 pr-3">
                                 <div class="tabs-cards-body mt-4">
                                    ...
                                    <p class="mt-3 card-content">This initiative will cultivate a generation that prioritizes compassion and community involvement, creating a ripple effect of positive social change for years to come.</p>
                                 </div>
                              </div>
                           </div>
                        </div>
                           ...
                           <div class="mt-5">
                              <div class="tabs-cards pl-3 pr-3">
                                 <div class="tabs-cards-body mt-4">
                                    ...
                                    <P class="tab-cards-title" >EXPECTED IMPACT</p>
                                    <p class="mt-3 card-content">This initiative will shift societal perspectives on aging, ensuring that seniors are valued and respected as integral members of their communities.</p>
                                 </div>
                              </div>
                           </div>
                        </div>
                ...
                <div class="content-padding">
                    <div class="row mx-0">
                        ...
                        <div class="col-md-6 text-content">
                            Atrium Legacy Foundation’s work is guided by four key pillars that reflect the evolving needs of seniors and caregivers:
                        </div>
                    </div>

                    <div class="row pt-5 pb-0">
                        <div class="col-md-6 col-lg-3 text-content d-flex px-1">
                            <div class="cards">
                                <div class="tab-icon icon1"></div>
                ...
                <div class="col-md-6 px-0 d-flex align-items-center">
                    <div class="text-left p-3 px-md-5 py-md-0">
                        ...
                        <ul>
                            ...
                            <li class="text-content">Community engagement and peer support</li>
                            <li class="text-content">Caregiver information and resource sessions</li>
                        </ul>
                ...
                <div class="row mx-0">
                    <div class="col-md-6 px-3">
                        <div class="content-padding">
                            ...
                            <p class="text-content-white mt-3" style="font-size: 1.2rem;">As we continue to grow, Atrium Legacy Foundation will expand initiatives that promote healthy aging, social inclusion, and community resilience. We remain committed to developing practical, scalable, and community-driven solutions that respond to emerging needs.</p>
                        </div>
                    </div>
                </div>
            </div>
