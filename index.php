            ...
            <div style="background-color: #e6ede6;">
                <div class="header_mid_inner pd-0">
                    <div class="content-padding">
                        ...
                        <h2 class="h2-title text-center">Our Focus</h2>
                    ...
                    <div class="col-md-6 col-lg-6 pl-0 pr-0 d-flex align-items-center">
                        <div class="text-left p-3 px-md-5 py-md-0">
                            ...
                            <ul>
                                ...
                                <li class="text-content">Help raise awareness about the importance of social connection</li>
                            </ul>
                            <div class="italic-heading">Together, we can create stronger, more inclusive communities for seniors.</div>
                        </div>
                    </div>
                </div>
            </div>
